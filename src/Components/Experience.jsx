        ...
        <section id='experience' className='py-20 px-6'>
            <div className='container mx-auto'>
                ...
                <div className='relative w-full mx-w-5xl mx-auto px-4 py-12'>
                    <div className="absolute hidden md:flex left-1/2 top-0 bottom-0 w-1 bg-sky-900 transform -translate-x-1/2"></div>
                                ...
                                return (
                                    <div key={index} className={`relative flex items-center w-full ${isLeft ? "md:justify-start" : "md:justify-end"} justify-center`}>
                                        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                                            <div className="hidden md:flex justify-center items-center w-12 h-12 rounded-full shadow-lg bg-sky-500">
